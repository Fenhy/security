 ...
 * @author Leon.
 */
public class CustomerAllStringAliasToBeanResultTransformer extends AliasedTupleSubsetResultTransformer {
     ...
     */
    public CustomerAllStringAliasToBeanResultTransformer(final Class<?> resultClassa) {
        ...
        try {
            ...
            for (int i = 0; i < this.aliases.length; i++) {
                if (setters[i] != null) {
                    ...
                    setters[i].set(result, tuple[i].toString(), null);
                }
            }
    ...
    public final boolean equals(final Object o) {
        ...
        CustomerAllStringAliasToBeanResultTransformer that = (CustomerAllStringAliasToBeanResultTransformer) o;
